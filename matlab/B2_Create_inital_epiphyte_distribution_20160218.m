...
SpeciesPoolsSpecific='ForestModel_Best_50x50_Pop1000-1010';
SpeciesPoolsSpecificAbb='Pop1000-1010'; %should to match with above
...
numSpeciesPools=[1,10]; %Start and end number of  species pools
...
NameSpeciesPoolSave=strcat(FolderSpeciesPools,'_',SpeciesPoolsSpecificAbb);
...
DirectorySpeciesPools=strcat(DirectorySpeciesPoolsMain,'\',FolderSpeciesPools,'\',SpeciesPoolsSpecific);
