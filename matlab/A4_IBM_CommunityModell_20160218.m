...
%FolderEpiphyteModels={'Dynamic_ForestModel_EM_20150914_2'};
FolderEpiphyteModels={'ForestModel_Best_50x50_Rep1','ForestModel_Best_50x50_Rep2','ForestModel_Best_50x50_Rep3','ForestModel_Best_50x50_Rep4'};
...
FolderInitialDistributions={'SP_Random_IA_2_IR_60_TimeS_200'};
...
numSpeciesPools=[91,100]; %Start and end number of  species pools (if the species pools do not exist, they are automatically skipped)replicatePerSpeciesPool=5; %Number of replicates per species pool  (if the replicates do not exist, they are automatically skipped)
...
for MicrohabitatNumber=1:length(FolderEpiphyteModels);
    ...
    for InititalDistNumber=1:length(FolderInitialDistributions);
        ...
        ColRecruitmentInc=find(ismember(ColumnHeaders,'RecruitmentInc'));
                ...
                for t=InitialTimeStep:(InitialTimeStep+timeSteps)
                   ...
                   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                    ...
                    for i=1:size(IndX,1)
                        ...
                        if CumulativeSumOfSurfaceSum<size(EpisInVoxel,1)
