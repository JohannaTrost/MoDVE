...
# Load ranges
base_dir <- "/Users/johanna/Uni/masterarbeit/data/modve_output/regua"
spec_distr <- read_csv(file.path(base_dir, "a5_species_distribution_cc_vs_no_cc.csv"))
...
write_csv(expected_curve,
          file.path(base_dir, "climdata_era5_cmip6_1981-2100_ssp245", "a5_mde_richness.csv"))